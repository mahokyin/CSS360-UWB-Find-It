            ...
            <div class="col-xs-12 col-sm-9">
                ...
                <div class="jumbotron">
                    <h1>
						...
						<font size="6" color="indigo"><b> Lost and Found System Management</b></font>
					</h1>
                    <p> <font size ="4">Manage items currently in Lost & Found Office Storage</font></p>
                    <p>
						<a href="../admin_listing/Listing.php" class="btn btn-primary" role="button">Add Item</a>
                        <form action="delete_all.php" method= "post">
						<input class="btn btn-primary" type = "submit" role="button" value = "Remove All">
                        </form>
					</p>
